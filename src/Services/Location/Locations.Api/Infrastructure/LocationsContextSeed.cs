...
namespace Locations.Api.Infrastructure
{
    public class LocationsContextSeed
    {
        ...
        static async Task SetIndexes()
        {
            ...
            var builder = Builders<Models.Locations>.IndexKeys;
